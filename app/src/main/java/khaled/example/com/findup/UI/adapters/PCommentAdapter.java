...
public class PCommentAdapter extends RecyclerView.Adapter<PCommentAdapter.ViewHolder> {
    ...
    public PCommentAdapter(Context mContext, List<ProductComment> commentList) {
        this.mContext = mContext;
        this.commentList = commentList;
    }

    public void setComments(List<ProductComment> comment) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PCommentAdapter.ViewHolder(itemView);
    }
